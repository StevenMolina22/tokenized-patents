  ...
  return (
    <div className="min-h-screen bg-[#292526] flex flex-col items-center justify-center">
      ...
      <div className="flex gap-8 mb-12">
        <button
          className="relative px-8 py-4 bg-white text-black font-semibold text-lg rounded-lg transform transition-all duration-200 hover:scale-105 active:scale-95"
          style={{
