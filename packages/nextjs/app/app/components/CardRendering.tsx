...
export default function CardRendering(isNextOne: boolean) {
    const patent = data.patents[isNextOne ? 0 : 1];
    const [showPrivacyModal, setShowPrivacyModal] = useState(false);
    const [showUnlockModal, setShowUnlockModal] = useState(false);
    const [showTokenPurchase, setShowTokenPurchase] = useState(false);
    const [agreedToTerms, setAgreedToTerms] = useState(false);
    const [tokenAmount, setTokenAmount] = useState(1000);
    const [tokenPrice, setTokenPrice] = useState(0.001); // ETH per token
    ...
    if (showUnlockModal) {
        return (
            <div className="bg-white rounded-4xl shadow-2xl p-8 h-[90vh] max-w-xl w-full mx-4 flex flex-col">
                ...
                {/* Title */}
                <h2 className="text-2xl font-bold text-gray-800 text-center mb-6">
                    Unlock access to innovation.
                </h2>

                {/* Main Content Text - Section 1 */}
                <p className="text-gray-700 mb-6 text-center">
                    View <strong>{currentPatent.title}</strong>'s confidential research data, financial projections, and IP strategy, information shared only with qualified investors.
                </p>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-700 text-sm">
                        This information is shared confidentially with serious investors. By proceeding, you agree to keep all details private and use them solely for investment evaluation.
                    </p>
                </div>
        ...
        >
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-6">
                    <span><strong>Seeking:</strong> {currentPatent.seeking}</span>
                    <span><strong>Stage:</strong> {currentPatent.stage}</span>
                    <span><strong>Valuation:</strong> {currentPatent.valuation}</span>
                    <span><strong>Runway:</strong> {currentPatent.runway}</span>
                </div>
                </div>
